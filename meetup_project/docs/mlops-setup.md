...
git add README.md docs .gitignore meetup_project/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[meetup_project/databricks.yml](../meetup_project/databricks.yml) file.
...
Follow the instructions in [meetup_project/resources/README.md](../meetup_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../meetup_project/resources/README.md)  to propose, test, and deploy
