...
Opening a pull request will trigger a[workflow](../.github/workflows/meetup_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-1221088626525134.14.azuredatabricks.net/explore/data/models/staging/meetup_project/meetup_project-model)
* [Prod model in UC](https://adb-2182082488917974.14.azuredatabricks.net/explore/data/models/prod/meetup_project/meetup_project-model)
. 
